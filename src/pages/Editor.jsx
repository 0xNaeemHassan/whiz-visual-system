...
export default function Editor({ activeFontPairing,showToast,activeTheme,setActiveTheme,editingFrame,clearEditingFrame,newFrameSignal,isActive}){
  ...
  const [collapsedStatProvenance, setCollapsedStatProvenance] = useState({});
  const [collapsedTableProvenance, setCollapsedTableProvenance] = useState({});
  ...
  const buildSave=()=>buildFrameSave({frameId,theme,content:normalizeContentWithProvenance(content),overrides,aspectRatio,bgGradient,patternOverlay,workflowPhase,phaseChecklist});
