...
export default function Editor({ activeFontPairing,showToast,activeTheme,setActiveTheme,editingFrame,clearEditingFrame,newFrameSignal,isActive}){
  ...
  useEffect(() => {
    ...
    const collisionReport = detectEntityCollisions(tableImportReport.validRows || []);
    track(TELEMETRY_EVENTS.DUPLICATE_RESOLUTION,{source:'row_edit',duplicateGroups:collisionReport.duplicateGroups.length,fuzzyPairs:collisionReport.fuzzyPairs.length,unresolvedHighConfidence:getUnresolvedHighConfidencePairs(collisionReport).length,reviewThreshold:collisionReport.thresholds.review,highConfidenceThreshold:collisionReport.thresholds.highConfidence,reviewerDecisionCount:Object.keys(collisionReviewDecisions).length});
  }, [tableImportText, collisionReviewDecisions]);
